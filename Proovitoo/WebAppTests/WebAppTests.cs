...
public class WebAppTests : BaseTest
{
    ...
    public void SaabLisadaJaKustutadaYritusi()
    {
        ...
        Assert.True(Kontrolli.YritusKorrektseteAndmetegaAsubAvalehel(_yritus, driver, Kontrolli.EYrituseTyyp.Tulevased, 0));
        Vajuta.VajutaAvaleheYrituseKustutamiseLinki(_yritus, driver);
        Assert.False(Kontrolli.YritusKorrektseteAndmetegaAsubAvalehel(_yritus, driver, Kontrolli.EYrituseTyyp.Tulevased, 0));
    }
    [Test]
    [Order(2)]
    ...
    public void SaabLisadaYrituseleOsalisi()
    {
        ...
        Vajuta.VajutaNuppu(Vajuta.ENupp.OSAVOTJALISAMINE_LISA, driver);
        Assert.True(Kontrolli.YritusKorrektseteAndmetegaAsubAvalehel(_yritus, driver, Kontrolli.EYrituseTyyp.Tulevased, (1 + (int)_jurosaleja!.OsalejateArv)));
        //Vajuta.VajutaAvaleheYrituseKustutamiseLinki(_yritus, driver);
    }
    [Test]
    [Order(5)]
