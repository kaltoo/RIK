...
{
    [Display(Name = "Sularaha")] Sularaha,
    [Display(Name = "Pangaülekanne")] Pangaylekanne
}
...
public class Osalemine : RemovableBaseEntity, IValidatableObject
{
    ...
    [ValidateNever] [BindNever] public Yritus Yritus { get; set; } = default!;
    ...
    [Comment(
        "Lisainfo väli osalejate soovidega. Rakenduse poolt piiratud füüsilise isiku korral varchar(1500). Juriidilise isiku puhul piirang varchar(5000).")]
