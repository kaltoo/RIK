...
public class YrituseDetailid : PageModel, ITitleViewCompatible, IAlertViewCompatible
{
    ...
    public YrituseDetailid(AppDbContext context)
    {
        _context = context;
    }
    ...
    [BindProperty(SupportsGet = true)] public int? KustutaOsalejaId { get; set; }

    public Yritus? Yritus { get; set; }

    [BindProperty(SupportsGet = true)] public string? ErrorMessage { get; set; }

    [BindProperty(SupportsGet = true)] public string? WarningMessage { get; set; }

    [BindProperty(SupportsGet = true)] public string? SuccessMessage { get; set; }
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        if (Id == null) return RedirectToPage(nameof(Index), new {ErrorMessage = "Ürituse ID puudu."});
